...
class Sentence():
    ...
    def mark_safe(self, cell):
        ...
        # If cell is in the sentence, remove it, but do not decrese the count
        if cell in self.cells:
            self.cells.remove(cell)
...
class MinesweeperAI():
    ...
    def make_random_move(self):
        ...
        # If no space are left that are acceptable moves, retun no move possible
        if space_left == 0:
            return None

        basic_prob = num_mines_left / space_left
