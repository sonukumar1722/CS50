...
class StackFrontier():
    ...
    def remove(self):
        if self.empty():
            ...
            node = self.frontier.pop()  # LIFO behavior for depth-first search
            return node

# Define a class for the frontier in breadth-first search
class QueueFrontier(StackFrontier):
    ...
    def remove(self):
        if self.empty():
            ...
            node = self.frontier.pop(0)  # FIFO behavior for breadth-first search
            return node
...
class Maze():
    ...
    def solve(self):
        ...
        frontier = StackFrontier()  # Depth-first search frontier
        frontier.add(start)
